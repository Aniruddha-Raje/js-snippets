...
let test = async () => {
    ...
    // SIGNING OPTIONS
    let signOptions = {
        issuer: constants.admin.tokenDetails.TestSlsRefreshToken.issuer,
        audience: constants.admin.tokenDetails.TestSlsRefreshToken.audience,
        subject: '29',
        expiresIn: constants.admin.tokenDetails.TestSlsRefreshToken.expiryInSeconds,
        algorithm: constants.admin.tokenDetails.TestSlsRefreshToken.algorithm
    };

    let token = jwt.sign(payload, constants.jwt.stageRefreshTokenPrivateKey, signOptions);
    ...
    var legit = jwt.verify(token, constants.jwt.stageRefreshTokenPublicKey, verifyOptions);
